...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Getting Started with LEGO Robotics: A Parent's Guide - Avanza STEM",
    description: "LEGO robotics kits make a great STEM introduction for kids. Learn which kit to choose, what your child will learn, and how to get started at home.",
