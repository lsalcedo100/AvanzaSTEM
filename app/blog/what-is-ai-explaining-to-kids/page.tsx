...
export const metadata = {
  ...
  description:
    "Artificial intelligence is everywhere, from voice assistants to video games. Learn how to explain AI concepts to kids in a way they will understand and enjoy.",
}
