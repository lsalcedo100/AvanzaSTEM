...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "How to Build the Strongest Popsicle Stick Bridge - Avanza STEM",
    description: "Learn the engineering secrets behind a strong popsicle stick bridge. Triangles, load paths, and joints — a step-by-step guide for young engineers.",
