    ...
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-avanza-teal to-avanza-green py-20">
        ...
        <div className="relative mx-auto max-w-7xl px-6 text-center">
          <span className="inline-flex items-center gap-2 rounded-full border-2 border-dashed border-primary-foreground/40 bg-white/10 px-4 py-1.5 text-xs font-extrabold uppercase tracking-[0.18em] text-primary-foreground backdrop-blur-sm">
            <Camera className="h-3.5 w-3.5" />
            {t.galleryPage.eyebrow ?? "Snapshots from class"}
          </span>
          <h1 className="mt-5 text-balance text-4xl font-extrabold leading-tight text-primary-foreground md:text-6xl">
            {t.galleryPage.title}
          </h1>
