...
export const LEVELS: Level[] = [
  // 1 — Complete a simple circuit to light one bulb.
  {
    ...
    hints: [
      ...
      },
      {
        ...
        pt: "Coloque um fio na casa vazia da fileira de baixo para fechar o circuito.",
      },
    ],
    goal: {
      ...
      pt: "Falta um fio no circuito. Coloque-o para a corrente dar a volta inteira e a lâmpada acender.",
    },
    tools: ["wire", "eraser"],
    success: { minLit: 1 },
    build: () =>
  ...
  // 2 — Add or close a switch to complete the circuit.
  {
    ...
    goal: {
      ...
      pt: "Está tudo ligado, mas o interruptor está aberto. Use a ferramenta Mão para fechá-lo e acender a luz.",
    },
    tools: ["hand"],
    success: { minLit: 1 },
    build: () =>
  ...
  // 3 — Fix a missing wire in a broken circuit.
  {
    ...
    hints: [
      ...
      },
      {
        ...
        zh: "检查右边，电流没法回下去。",
        pt: "Confira o lado direito. A corrente não consegue descer de volta.",
      },
      {
        ...
        pt: "Coloque um fio no trilho da direita para a lâmpada se ligar de volta à pilha.",
      },
    ],
    goal: {
      ...
      pt: "Este circuito funcionava até um fio sumir. Encontre a falha e feche-a para a lâmpada acender de novo.",
    },
    tools: ["wire", "eraser"],
    success: { minLit: 1 },
    build: () =>
  ...
  // 4 — Light two bulbs in series.
  {
    ...
    challenge: {
      ...
      zh: "你能用一个回路点亮两盏灯吗？",
      pt: "Você consegue acender as duas lâmpadas em um só circuito?",
    },
    title: { en: "Two in a row", es: "Dos en serie", zh: "串联两盏灯", pt: "Duas em série" },
    hints: [
      {
      ...
      },
      {
        ...
        pt: "Coloque uma segunda lâmpada na casa vazia para as duas dividirem o circuito em série.",
      },
    ],
    goal: {
      ...
      pt: "Já existe uma lâmpada no circuito. Coloque uma segunda na falha para as duas acenderem em série.",
    },
  ...
  // 5 — Light two bulbs in parallel.
  {
    id: 5,
    targetParts: 9,
    title: { en: "Side by side", es: "Lado a lado", zh: "并联两盏灯", pt: "Lado a lado" },
    hints: [
      {
        en: "One bulb already glows on its own branch.",
        es: "Un foco ya brilla en su propia rama.",
        zh: "一盏灯已经在自己的支路上亮着。",
        pt: "Uma lâmpada já acende no ramo dela.",
      },
      {
        ...
        pt: "Há espaço para uma segunda lâmpada em outro caminho entre os trilhos.",
      },
      {
        ...
        pt: "Coloque uma lâmpada na casa do meio para as duas acenderem lado a lado.",
      },
    ],
    goal: {
      ...
      pt: "A lâmpada de cima acende no ramo dela. Coloque uma segunda no meio para as duas brilharem em paralelo.",
    },
    tools: ["bulb", "wire", "eraser"],
    success: { minLit: 2 },
    build: () =>
  ...
  // 6 — One switch controls two bulbs.
  {
    ...
    challenge: {
      ...
      zh: "你能用一个开关点亮两盏灯吗？",
      pt: "Você consegue acender as duas lâmpadas com um interruptor só?",
    },
    title: { en: "One switch, two lights", es: "Un interruptor, dos luces", zh: "一个开关控两灯", pt: "Um interruptor, duas luzes" },
    hints: [
      {
        en: "Both bulbs share one loop with a single control.",
        es: "Ambos focos comparten un circuito con un solo control.",
        zh: "两盏灯共用一个回路和一个开关。",
        pt: "As duas lâmpadas dividem um circuito com um único controle.",
      },
      {
        ...
        zh: "开关断开，两盏灯都没有电流。",
        pt: "O interruptor está aberto, então nenhuma corrente chega às lâmpadas.",
      },
      {
        ...
        pt: "Feche o interruptor com a ferramenta Mão para acender as duas de uma vez.",
      },
    ],
    goal: {
      ...
      pt: "Duas lâmpadas dividem um único circuito com um interruptor. Feche o interruptor para acender as duas de uma vez.",
    },
    tools: ["hand"],
  ...
  // 7 — Each bulb controlled by its own switch.
  {
    id: 7,
    targetParts: 12,
    title: { en: "Your own switch", es: "Cada quien su interruptor", zh: "各自的开关", pt: "Cada uma com seu interruptor" },
    hints: [
      {
        ...
        pt: "O ramo de cima tem o próprio interruptor. Falta algo no ramo de baixo.",
      },
      {
        en: "Each bulb should have its own switch to control it.",
        es: "Cada foco debería tener su propio interruptor.",
        zh: "每盏灯都应该有自己的开关来控制。",
        pt: "Cada lâmpada deve ter o próprio interruptor para controlá-la.",
      },
      {
        ...
        pt: "Coloque um interruptor no ramo de baixo e depois feche os dois.",
      },
    ],
    goal: {
      ...
      pt: "O ramo de cima tem o próprio interruptor; falta um no ramo de baixo. Coloque um interruptor no ramo de baixo e feche os dois, para cada lâmpada ter o próprio controle.",
    },
  ...
  // 8 — Fix a short circuit.
  {
    ...
    challenge: {
      ...
      zh: "你能避免短路吗？",
      pt: "Você consegue evitar um curto-circuito?",
    },
    title: { en: "Stop the short", es: "Detén el corto", zh: "修好短路", pt: "Acabe com o curto" },
    hints: [
      {
      ...
      },
      {
        ...
        pt: "Troque um fio por uma lâmpada para a corrente ter algo para alimentar.",
      },
    ],
    goal: {
  ...
  // 9 — Fewest parts.
  {
    ...
    challenge: {
      ...
      zh: "你能只用 6 段电线完成吗？",
      pt: "Você consegue resolver com apenas 6 fios?",
    },
    title: { en: "Keep it short", es: "Lo más corto", zh: "用最少的零件", pt: "Use o mínimo de peças" },
    hints: [
      {
        en: "Connect the battery to the bulb and back into one loop.",
        es: "Conecta la pila al foco y de regreso en un solo circuito.",
        zh: "把电池和灯泡连成一个回路。",
        pt: "Ligue a pilha à lâmpada e de volta, formando um circuito.",
      },
      {
    ...
    goal: {
      ...
      pt: "Ligue a pilha à lâmpada e de volta. Tente fechar o circuito usando o menor número de fios possível.",
    },
    tools: ["wire", "eraser"],
    success: { minLit: 1 },
    build: () =>
  ...
  // 10 — Repair a house circuit with multiple branches.
  {
    ...
    challenge: {
      ...
      zh: "你能点亮每个房间且不短路吗？",
      pt: "Você consegue acender todos os cômodos sem causar um curto?",
    },
    ...
    hints: [
      ...
      },
      {
        ...
        pt: "Um cômodo está sem lâmpada, e o trilho de cima tem uma falha.",
      },
      {
        ...
        pt: "Coloque a lâmpada que falta no cômodo vazio e conserte o trilho de cima.",
      },
    ],
    goal: {
      ...
      pt: "Três cômodos dividem a mesma alimentação. Coloque a lâmpada que falta e conserte o trilho rompido para todas as luzes acenderem.",
    },
    tools: ["bulb", "wire", "eraser"],
  ...
  // 11 — Two bulbs in series: close the loop, then see them share (and dim).
  {
    ...
    challenge: {
      ...
      pt: "Você sabe dizer por que duas lâmpadas em série ficam mais fracas?",
    },
    ...
    hints: [
      ...
      },
      {
        ...
        pt: "As duas lâmpadas estão no mesmo caminho, então a corrente precisa passar pelas duas.",
      },
      {
        ...
        pt: "Coloque o último fio. As lâmpadas dividem a energia da pilha, então cada uma brilha mais fraco.",
      },
    ],
    goal: {
  ...
  // 12 — Parallel branches required: a single series loop is NOT accepted.
  {
    ...
    challenge: {
      ...
      pt: "As duas lâmpadas fortes, cada uma no próprio ramo?",
    },
    title: { en: "Bright branches", es: "Ramas brillantes", zh: "明亮的支路", pt: "Ramos brilhantes" },
    hints: [
      {
        ...
        pt: "Monte um trilho em cima e um embaixo, para cada lâmpada ligar um ao outro.",
      },
      {
        ...
        pt: "Cada lâmpada precisa do próprio caminho do + de volta ao −, não de um circuito compartilhado.",
      },
      {
        ...
        pt: "Ligue a fileira de cima inteira e a de baixo inteira; as duas lâmpadas então brilham forte em paralelo.",
      },
    ],
    goal: {
