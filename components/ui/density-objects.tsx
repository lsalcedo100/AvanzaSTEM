...
export const DENSITY_OBJECTS: DensityObject[] = [
  {
    ...
    noteLoc: {
      ...
      zh: "软木来自栓皮栎那层松软的树皮。",
      pt: "A rolha vem da casca esponjosa do sobreiro.",
    },
    category: "everyday",
    density: 0.24,
    volume: 5,
  ...
  },
  {
    ...
    noteLoc: {
      ...
      pt: "A água é uma das poucas coisas que ficam mais leves ao congelar.",
    },
    category: "nature",
    density: 0.92,
    volume: 10,
  ...
  {
    id: "penny",
    nameLoc: { en: "Penny", es: "Moneda", zh: "硬币", pt: "Moeda" },
    materialLoc: { en: "Copper", es: "Cobre", zh: "铜", pt: "Cobre" },
    blurbLoc: {
  ...
  {
    id: "grape",
    nameLoc: { en: "Grape", es: "Uva", zh: "葡萄", pt: "Uva" },
    materialLoc: { en: "Fruit", es: "Fruta", zh: "水果", pt: "Fruta" },
    blurbLoc: {
      en: "Just a little heavier than water, so it sinks slowly.",
      es: "Apenas un poco más pesada que el agua, así que se hunde despacio.",
      zh: "只比水稍重一点，所以会慢慢下沉。",
      pt: "Só um pouquinho mais pesada que a água, então afunda devagar.",
    },
    noteLoc: {
      ...
      pt: "A uva afunda na água, mas flutua no mel ou no xarope de milho.",
    },
    category: "nature",
    density: 1.05,
    volume: 4,
  ...
  {
    id: "tomato",
    nameLoc: { en: "Tomato", es: "Tomate", zh: "番茄", pt: "Tomate" },
    materialLoc: { en: "Fruit", es: "Fruta", zh: "水果", pt: "Fruta" },
    blurbLoc: {
      en: "Almost exactly as heavy as water for its size.",
      es: "Casi igual de pesado que el agua para su tamaño.",
      zh: "同样大小下几乎和水一样重。",
      pt: "Quase exatamente tão pesado quanto a água para o tamanho dele.",
    },
    noteLoc: {
      ...
      pt: "Tomates maduros ficam bem perto da densidade da água, parados quase na superfície.",
    },
    category: "nature",
    density: 1.02,
    volume: 100,
  ...
  {
    id: "wood",
    nameLoc: { en: "Wood block", es: "Bloque de madera", zh: "木块", pt: "Bloco de madeira" },
    materialLoc: { en: "Pine wood", es: "Madera de pino", zh: "松木", pt: "Madeira de pinho" },
    blurbLoc: {
      en: "Lighter than water, so it bobs on top.",
      es: "Más ligera que el agua, así que flota arriba.",
      zh: "比水轻，所以会浮在上面。",
      pt: "Mais leve que a água, então boia por cima.",
    },
    noteLoc: {
      ...
      pt: "A maioria das madeiras flutua porque é cheia de bolsinhas de ar.",
    },
    category: "nature",
    density: 0.65,
    volume: 20,
  ...
  {
    id: "plastic",
    nameLoc: { en: "Plastic cap", es: "Tapa de plástico", zh: "塑料瓶盖", pt: "Tampinha de plástico" },
    materialLoc: { en: "Polypropylene", es: "Polipropileno", zh: "聚丙烯", pt: "Polipropileno" },
    blurbLoc: {
  ...
  },
  {
    ...
    noteLoc: {
      ...
      pt: "As pedras são bem compactadas de minerais, por isso afundam na água.",
    },
    category: "nature",
    density: 2.65,
    volume: 8,
  ...
  {
    id: "aluminum",
    nameLoc: { en: "Aluminum cube", es: "Cubo de aluminio", zh: "铝块", pt: "Cubo de alumínio" },
    materialLoc: { en: "Aluminum", es: "Aluminio", zh: "铝", pt: "Alumínio" },
    blurbLoc: {
      en: "A light metal, but still much denser than water.",
      es: "Un metal ligero, pero aún mucho más denso que el agua.",
      zh: "一种轻金属，但密度仍远大于水。",
      pt: "Um metal leve, mas ainda muito mais denso que a água.",
    },
    noteLoc: {
      ...
      zh: "铝在金属里算轻的，所以飞机会用它。",
      pt: "O alumínio é leve para um metal, e é por isso que os aviões o usam.",
    },
  ...
  },
  {
    ...
    noteLoc: {
      ...
      pt: "O aço afunda na água, mas flutua no mercúrio, que é bem mais denso.",
    },
    category: "engineering",
    density: 7.85,
    volume: 4,
  ...
  },
  {
    ...
    noteLoc: {
      ...
      pt: "O ouro puro tem 19,3 g/cm³. O ouro de joia é misturado com outros metais, então é um pouco mais leve.",
    },
    category: "engineering",
    density: 19.3,
    volume: 0.5,
  ...
  {
    id: "mysteryA",
    nameLoc: { en: "Candle wax", es: "Cera de vela", zh: "蜡烛蜡", pt: "Cera de vela" },
    materialLoc: { en: "Paraffin wax", es: "Cera de parafina", zh: "石蜡", pt: "Parafina" },
    blurbLoc: {
  ...
  },
  {
    ...
    noteLoc: {
      ...
      zh: "铅的密度极大，一小块也重得吓人。",
      pt: "O chumbo é tão denso que um pedacinho já parece pesadíssimo.",
    },
    category: "mystery",
    density: 11.34,
    volume: 2,
