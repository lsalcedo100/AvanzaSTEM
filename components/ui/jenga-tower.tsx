...
const JENGA_COPY: Record<Language, {
  ...
  pt: {
    levels: [
      { name: "Primeira torre", tip: "Use só blocos comuns. Monte uma torre simples e centralizada com as peças da bandeja." },
      { name: "Construção mais alta", tip: "Quanto mais alto, mais um desvio pequeno pesa. Mantenha cada fileira o mais centrada possível." },
      { name: "Base estreita", tip: "A área de apoio é bem mais estreita, então a posição do centro de gravidade importa mais." },
      { name: "Blocos pesados", tip: "Os blocos mais escuros são mais pesados. Embaixo eles ajudam; em cima, atrapalham." },
      { name: "Teste de vento", tip: "O vento começa durante a contagem. Uma torre centrada e larga aguenta as rajadas." },
    ],
    initialCoach: "Construa até a linha da meta e depois deixe a torre estabilizar.",
    holdCoach: "Mantenha firme. Não mexa nos blocos durante a contagem.",
    lostSupport: "A torre perdeu o caminho de apoio.",
    lostSupportRebuild: "A torre perdeu o caminho de apoio. Reconstrua com uma base mais larga.",
    continueCoach: "Você pode continuar construindo sobre esta torre ou ajustar os blocos antes de tentar a contagem.",
    mission: "Construa uma torre de {rows} fileiras e mantenha-a em pé por {seconds} segundos.",
    levelCount: "Nível {current} de {total}",
    start: "Começar",
    nextChallenge: "Próximo desafio",
    keepBuilding: "Continuar construindo",
    tryAgain: "Tentar de novo",
    rebuildTower: "Reconstruir a torre",
    state: "Situação",
    hold: "Mantenha",
    stableHeight: "Altura estável",
    bestHeight: "Melhor altura",
    target: "Meta",
    row: "fileira",
    rows: "fileiras",
    stability: "Estabilidade",
    supplyTray: "Bandeja de blocos",
    notTested: "Ainda não testado",
    closeComplete: "Fechar o aviso de nível concluído e continuar construindo",
    levelComplete: "Nível concluído!",
    greatBuild: "Ótima construção.",
    success: "Você chegou a {rows} fileiras de altura estável e manteve a torre em pé por {seconds} segundos.",
    rebuildThisLevel: "Reconstruir este nível",
    towerCollapsed: "A torre caiu!",
    rebuildSupport: "Refaça o caminho de apoio.",
    collapseTip: "Tente uma base mais larga, deixe o próximo bloco mais perto do centro e espere a torre estabilizar antes de subir mais.",
    phase: { loading: "Carregando", ready: "Pronto", building: "Construindo", holding: "Mantendo", success: "Concluído", collapsed: "Caiu", error: "Erro" },
    band: { stable: "Estável", wobbling: "Balançando", danger: "Perigo", collapsed: "Caiu" },
  },
}
